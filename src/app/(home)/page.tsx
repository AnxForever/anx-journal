...
export default function Home() {
	...
	return (
		<>
			{siteContent.enableChristmas && <SnowfallBackground zIndex={0} count={!maxLG ? 125 : 20} />}
			...
			<div className='max-lg:flex max-lg:flex-col max-lg:items-center max-lg:gap-6 max-lg:pt-28 max-lg:pb-20'>
			...
			{siteContent.enableChristmas && <SnowfallBackground zIndex={2} count={!maxLG ? 125 : 20} />}
